...
const AppliedJobs = () => {
    ...
    const handleFilter = (e) => {
        ...
        if (selectedValue === 'Filter') {
            ...
            const ll = data.filter((single) => single.category == selectedValue);
            setStoredJob(ll);
        }
    }
    return (
        <div>
            <h1 className='text-5xl text-center bg-gradient-to-r from-indigo-500 to-indigo-800 bg-clip-text text-transparent p-2 mb-4 '>Applied Benefits</h1>
            <div>
