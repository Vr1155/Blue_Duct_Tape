...
const JobSection = () => {
    ...
    return (
        <div className='text-center my-6'>
            <h1 className='text-5xl custom-text p-4'>Featured Benefits </h1>
            <p className='text-lg my-4'>Explore thousands of benefits with all the information you need. Its your future</p>
