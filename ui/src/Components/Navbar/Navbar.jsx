            ...
            <div className="navbar bg-base-100 p-5 ">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 ">
                            ...
                            <li>
                                <Link to="/AskAI" className='default'>
                                    Ask AI
                                </Link>
                            </li>
                    ...
                    <Link to="/" className='normal-case text-5xl custom-text font-bold'>BLUE DUCT TAPE</Link>
                </div>
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal px-1 tracking-wider font-medium">
                        ...
                        <li>
                                <Link to="/AskAI" className={({ isActive }) => (isActive ? 'text-blue-600' : 'default')}>
                                    Ask AI
                                </Link>
                            </li>
                        {/* <li>
