...
const JobDetails = () => {
    ...
    return (
        <div >
            <h1 className='text-5xl text-center bg-gradient-to-r from-indigo-500 to-indigo-800 bg-clip-text text-transparent p-2 mb-8'>{details.title} - Details</h1>
            <div className='md:flex px-16 gap-6'>
                <div className="left w-11/12 text-lg">
                    <h1 className='tracking-wide'>
                        <span className='font-bold'>Description: </span>{details.description}</h1>
                </div>
                <div className='md:w-2/4'>
                    <div className="right  rounded-xl border-4 p-4 leading-loose">
                        ...
                        <p className='flex mt-2 md:items-center' >
                            ...
                            <div>
                                <span className='font-bold ml-2'>Benefit: </span>
                                {details.title}
                            </div>
                        </p>
                        <p className='flex mt-2 md:items-center' >
                            <CalendarDaysIcon className="h-6 w-6 text-blue-500" />
                            <div>
                                <span className='font-bold ml-2'>Type: </span>
                                {details.type}
                            </div>
                        </p>
